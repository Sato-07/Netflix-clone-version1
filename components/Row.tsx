...
function Row({title, movies}: Props) {
  ...
  return (
    <div className='h-40 space-y-0.5 md:space-y-3 md:-ml-7'>

        <h2 className='w-56 cursor-pointer text-sm font-semibold text-[#e5E5E5E5]
        transition duration-200 hover:text-white md:space-y-3 md:text-2xl'>{title}</h2>
        ...
        <div className='group relative md:-ml-2'>
            ...
            <div
                ...
                ref={rowRef}
                className='flex items-center space-x-0.5 overflow-scroll 
