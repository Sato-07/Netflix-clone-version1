...
function Modal() {
  ...
  return (
    <MuiModal 
      open={showModal} 
      onClose={handleClose}
      className="fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden scrollbar-hide overflow-y-scroll rounded-md"
    >
        <>
        ...
        <div className="flex space-x-16 rounded-n-md bg-[#181818] px-10 py-8">
